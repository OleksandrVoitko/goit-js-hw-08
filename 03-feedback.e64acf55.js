...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a={form:document.querySelector(".feedback-form"),email:document.querySelector(".feedback-form input"),message:document.querySelector(".feedback-form textarea")},s=localStorage.getItem("feedback-form-state");if(s){const e=JSON.parse(s);e.email&&(a.email.value=e.email),e.message&&(a.message.value=e.message)}function r(e){if(e.preventDefault(),!a.email.value||!a.message.value)return alert("All fields must be filled!");const t=localStorage.getItem("feedback-form-state"),s=JSON.parse(t);console.log(`Email: ${s.email}`),console.log(`Message: ${s.message}`),localStorage.removeItem("feedback-form-state"),e.currentTarget.reset()}function l(e){const t={};t.message=a.message.value,t[e.target.name]=e.target.value;const s=JSON.stringify(t);localStorage.setItem("feedback-form-state",s)}function o(e){const t={};t[e.target.name]=e.target.value,t.email=a.email.value;const s=JSON.stringify(t);localStorage.setItem("feedback-form-state",s)}a.form.addEventListener("submit",r),a.email.addEventListener("input",(0,e.default)(l,500)),a.message.addEventListener("input",(0,e.default)(o,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.e64acf55.js.map